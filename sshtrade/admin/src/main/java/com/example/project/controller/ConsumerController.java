...
public class ConsumerController {
    ...
    public Result save(@RequestBody Consumer consumer) {
        ...
        user.setEmail(consumer.getUsername()+"@qq.com");
        user.setAddress("");
    ...
    public Result update(@RequestBody Consumer consumer) {
        ...
        UserMapper userMapper = SpringContextUtil.getBean(UserMapper.class);
        User dbUser = userMapper.selectById(consumer.getUserId());
        dbUser.setName(consumer.getName());
    ...
    public Result deleteBatch(@RequestBody List<Integer> ids) {
        consumerService.removeByIds(ids);
        return Result.success();
    }
    ...
    */
    ...
    public void export(HttpServletResponse response) throws Exception {
        ...
        String fileName = URLEncoder.encode("Consumer信息表", "UTF-8");
    ...
    */
    ...
    public Result imp(MultipartFile file) throws Exception {
        ...
        List<Consumer> list = reader.readAll(Consumer.class);

        consumerService.saveBatch(list);
        return Result.success();
    }
