...
public class PaytypeController {
    ...
    @AutoLog("新增支付类型")
    @PostMapping
    public Result save(@RequestBody Paytype paytype) {
    ...
    @AutoLog("编辑支付类型")
    @PutMapping
    public Result update(@RequestBody Paytype paytype) {
    ...
    public Result deleteBatch(@RequestBody List<Integer> ids) {
        paytypeService.removeByIds(ids);
        return Result.success();
    }
    ...
    public Result findPage(@RequestParam(defaultValue = "") String name,
        ...
        QueryWrapper<Paytype> queryWrapper = new QueryWrapper<Paytype>().orderByDesc("id");
        ...
        return Result.success(paytypeService.page(new Page<>(pageNum, pageSize), queryWrapper));
    }
    ...
    */
    ...
    public void export(HttpServletResponse response) throws Exception {
        ...
        String fileName = URLEncoder.encode("Paytype信息表", "UTF-8");
    ...
    */
    ...
    public Result imp(MultipartFile file) throws Exception {
        ...
        List<Paytype> list = reader.readAll(Paytype.class);

        paytypeService.saveBatch(list);
        return Result.success();
    }
