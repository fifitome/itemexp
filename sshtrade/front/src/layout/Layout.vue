...
<template>
  <div>
    <div style="height: 60px; line-height: 60px; border-bottom: 1px solid #ccc; background-color: #f18e4c">
        ...
        <div style="flex: 1; display: flex">
          ...
          <div style="width: 300px; text-align: right; padding-right: 20px">
            ...
            <el-dropdown>
              ...
              <template #dropdown>
                <el-dropdown-menu>
                  <el-dropdown-item><div @click="router.push('/front')">访问首页</div></el-dropdown-item>
    ...
    <div style="display: flex;">
      <div style="width: 230px; min-height: calc(100vh - 60px); border-right: 1px solid #ccc;background-color: #f18e4c">
        <el-menu
