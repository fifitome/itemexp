  ...
  <div>
    ...
    <div style="margin: 10px 0">
      <el-table :data="state.tableData" stripe border  @selection-change="handleSelectionChange">
        ...
        <el-table-column label="聊天内容"><template #default="scope"><el-button @click="view(scope.row.content)">查看</el-button></template></el-table-column>
    ...
    <el-dialog v-model="dialogFormVisible" title="私聊信息" width="40%">
      <el-form ref="ruleFormRef" :rules="rules" :model="state.form" label-width="80px" style="padding: 0 20px" status-icon>
        <el-form-item label-width="100" prop="fromId" label="发送者">
        ...
        <el-form-item label-width="100" prop="toId" label="接收者">
        ...
        <el-form-item label-width="100" prop="content" label="聊天内容">
