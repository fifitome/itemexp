...
<template>
  <div>
    ...
    <div style="margin-top: 20px;">
      <el-card>
        <div style="padding-bottom: 15px ;border-bottom: 1px solid #ddd; margin-top: 20px;text-align: center;">
          <span style="font-weight: bold; font-size: 24px;">购物车</span>
        </div>
        ...
        <el-table :data="state.tableData" style="width: 100%;margin-top: 20px;">
          ...
          <el-table-column prop="name" label="商品" width="320px;"></el-table-column>
        ...
        <div class="address-list">
          ...
          <div style="margin-top: 10px;text-align: right;">
            <el-button type="text" @click="router.push('/front/address')">管理收货地址</el-button>
          </div>
        ...
        <div class="detail-btn" style="margin-top: 20px;margin-bottom: 50px;">
          <div @click="toOrder"><i class="el-icon-date"></i>订单结算</div>
        </div>
      </el-card>
    </div>
    ...
    <el-dialog v-model="dialogFormVisible" title="订单支付" width="40%">
      ...
      <div style="margin-top: 10px;text-align: center;">
        <el-button type="primary" @click="saveOrder">确认支付</el-button>
      </div>
    </el-dialog>
