    ...
    <div style="margin-top: 20px;">
      <el-card>
        <div style="padding-bottom: 15px ;border-bottom: 1px solid #ddd; margin-top: 20px;text-align: center;">
          <span style="font-weight: bold; font-size: 24px;">网站公告</span>
        </div>
        ...
        <el-table :data="state.tableData" style="width: 100%;margin-top: 20px;">
          ...
          <el-table-column label="操作"><template #default="scope"><el-button type="primary" size="small" @click="router.push('/front/notice-detail?id='+scope.row.id)" >查看</el-button></template></el-table-column>
        </el-table>
