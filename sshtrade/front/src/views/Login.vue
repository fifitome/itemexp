      ...
      <div>
        <div style="width: 450px; background-color: white; padding: 30px 40px;">
          <el-form
              ...
              status-icon
          >
            <div style="text-align: center; color: #f18e4c; font-size: 30px; font-weight: bold; margin-bottom: 30px">
              用户登录
            </div>
            ...
            <el-form-item>
              <el-button type="primary" style="width: 100%;background-color: #f18e4c" @click="login">登 录</el-button>
            </el-form-item>
          </el-form>
          <div style="text-align: right">
            <a style="text-decoration: none; color: #f18e4c" href="/front">访问首页</a>&nbsp;&nbsp;
            <a style="text-decoration: none; color: #f18e4c" href="/register-consumer">用户注册</a>&nbsp;&nbsp;
          </div>
        </div>
      </div>
    </div>
