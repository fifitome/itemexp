  ...
  <div>
    ...
    <div style="margin: 10px 0">
      <el-table :data="state.tableData" stripe border  @selection-change="handleSelectionChange">
        ...
        <el-table-column prop="id" label="收货地址编号"></el-table-column>
        <el-table-column prop="name" label="姓名"></el-table-column>
        <el-table-column prop="phone" label="手机"></el-table-column>
        <el-table-column prop="address" label="详细地址"></el-table-column>
        <el-table-column prop="postcode" label="邮编"></el-table-column>
        <el-table-column label="用户编号"><template #default="scope"><span v-if="scope.row.userId">{{ state.userOptions.find(v => v.id === scope.row.userId) ? state.userOptions.find(v => v.id === scope.row.userId).name : '' }}</span></template></el-table-column>
    ...
    <el-dialog v-model="dialogFormVisible" title="收货地址信息" width="40%">
      <el-form ref="ruleFormRef" :rules="rules" :model="state.form" label-width="80px" style="padding: 0 20px" status-icon>
        ...
        <el-form-item label-width="100" prop="phone" label="手机">
          <el-input v-model="state.form.phone" autocomplete="off"></el-input>
        </el-form-item>
        <el-form-item label-width="100" prop="address" label="详细地址">
          <el-input v-model="state.form.address" autocomplete="off"></el-input>
        </el-form-item>
        <el-form-item label-width="100" prop="postcode" label="邮编">
          <el-input v-model="state.form.postcode" autocomplete="off"></el-input>
        </el-form-item>
        <el-form-item label-width="100" prop="defaultRadio" label="是否默认">
          <el-radio-group v-model="state.form.defaultRadio">
