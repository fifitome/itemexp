...
<template>
  <div>
      ...
      <el-table :data="state.tableData" stripe border  @selection-change="handleSelectionChange">
        ...
        <el-table-column label="操作" width="180">
          <template #default="scope">
            <el-button type="primary" @click="handleEdit(scope.row)" v-if="auths.includes('category.edit')">编辑</el-button>
    ...
    <el-dialog v-model="dialogFormVisible" title="商品分类信息" width="40%">
