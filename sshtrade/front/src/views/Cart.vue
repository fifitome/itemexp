  ...
  <div>
    ...
    <div style="margin: 10px 0">
      <el-table :data="state.tableData" stripe border  @selection-change="handleSelectionChange">
        ...
        <el-table-column prop="id" label="购物车编号"></el-table-column>
        <el-table-column label="购买用户"><template #default="scope"><span v-if="scope.row.userId">{{ state.userOptions.find(v => v.id === scope.row.userId) ? state.userOptions.find(v => v.id === scope.row.userId).name : '' }}</span></template></el-table-column>
        ...
        <el-table-column label="操作" width="180">
          <template #default="scope">
            <el-button type="primary" @click="handleEdit(scope.row)" v-if="auths.includes('cart.edit')">编辑</el-button>
    ...
    <el-dialog v-model="dialogFormVisible" title="购物车信息" width="40%">
      <el-form ref="ruleFormRef" :rules="rules" :model="state.form" label-width="80px" style="padding: 0 20px" status-icon>
        <el-form-item label-width="100" prop="name" label="购买商品">
          <el-input v-model="state.form.name" autocomplete="off"></el-input>
        </el-form-item>
        <el-form-item label-width="100" prop="num" label="数量">
          <el-input v-model="state.form.num" autocomplete="off"></el-input>
        </el-form-item>
        <el-form-item label-width="100" prop="price" label="单价">
        ...
        <el-form-item label-width="100" prop="goodid" label="产品编号">
