...
const router = createRouter({
  ...
  routes: [
    ...
    },
    {
      ...
      component: () => import('../views/Register-consumer.vue')
    },
    {
      path: '/404',
      name: '404',
    ...
    // 前台页面路由
    {
      ...
      children: [
        ...
        { path: 'product-list', name: 'product-list', component: () => import('../views/front/Product.vue') },
        ...
        { path: 'product-detail', name: 'product-detail', component: () => import('../views/front/ProductDetail.vue') },
